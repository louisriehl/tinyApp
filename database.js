const db = {
  "zPoPpHxQ": {
    b2xVn2: { long: "http://www.lighthouselabs.ca", date: "Wed May 21 1994", visits: 0, unique: 0},
    s9m5xK: { long: "http://www.google.com", date: "Mon Jan 01 2000", visits: 0, unique: 0 },
    ba985d: { long: "https://www.example.com", date: "Sat Jul 18 2077", visits: 0, unique: 0 }
  }
};
...
module.exports = {
  ...
  add: (id, short, lo, dt) => { db[id][short] = { long: lo, date: dt, visits: 0, unique: 0}},
